...
export default function ApproverOverview() {
  ...
  const responsibleUsersCount = 0
  const responsibleClassesCount = 0
  const responsibleInquiriesCount = 0
  const responsibleDeclinedInquiriesCount = 0
  const responsibleApprovedInquiriesCount = 0
  const responsiblePendignInquiriesCount = 0
  ...
  // Function to filter activities based on department match
  const filteredActivities = allActivities.filter((activity) => {
    // Normalize responsibleDepartments and userDepartments to lowercase for case-insensitive matching
    const responsibleDepartments = activity?.responsibleDepartments || [];

    // Check if there's any overlap between user's additional departments and activity's responsible departments
    return responsibleDepartments.some((dept) =>
      userDepartments.map((userDept) => userDept.toLowerCase()).includes(dept.toLowerCase()) || dept === "Alle"
    );
  });
...
// });
  ...
  return (
    <>
      <div className="hidden lg:grid mb-6 grid gap-y-10 gap-x-6 px-10 mt-10 md:grid-cols-2 xl:grid-cols-4">
        <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
          ...
          <div className="p-4 text-right">
            <h6 className="block antialiased tracking-normal text-[15px] font-semibold leading-relaxed text-blue-gray-900 mb-1">
              Abteilungen unter meiner Verantwortung
            </h6>
            <h4 className="block antialiased tracking-normal  text-2xl font-semibold leading-snug text-blue-gray-900">
              {!allUsers ? (
                ...
                user.additionalDepartments.length
              )}
            </h4>
          </div>
          <div className="flex gap-3 items-center border-t border-blue-gray-50 p-4">
            <p className="block antialiased  text-base leading-relaxed font-semibold text-gray-400">
              Verantwortlich für insgesamt "VALUE" Mitarbeiter
            </p>
          </div>
        </div>
        ...
        <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
          ...
          <div className="flex gap-3 items-center border-t border-blue-gray-50 p-4">
            <p className="block antialiased  text-base leading-relaxed font-semibold text-gray-400">
              Davon "1" relevanter Kurs für deine Abteilungen
            </p>
          </div>
        </div>
        ...
        <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
          ...
          <div className="p-4 text-right">
            <h6 className="block antialiased tracking-normal  text-[15px] font-semibold leading-relaxed text-blue-gray-900 mb-1">
              Anzahl der Anfagen in diesem Monat
            </h6>
            <h4 className="block antialiased tracking-normal  text-2xl font-semibold leading-snug text-blue-gray-900">
              Hard coded
            </h4>
          ...
          <div className="border-t border-blue-gray-50 p-4">
            <p className="block antialiased  text-base leading-relaxed font-semibold text-gray-400">
              Davon "1" genehmigt und "1" abgelehnt
            </p>
          </div>
        </div>
        ...
        <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
          ...
          <div className="flex gap-3 items-center border-t border-blue-gray-50 p-4">
            <p className="block antialiased  text-base leading-relaxed font-semibold text-gray-400">
              Davon werden "1" automatisch abgelehnt
            </p>
          </div>
        </div>
      </div>
