              ...
              >
                ...
                <div className="grid grid-cols-4 grid-rows-3">
                    {[
                      ...
                      { value: "https://res.cloudinary.com/dtrymbvrp/image/upload/v1715088434/symbols/o4qwfioe3dkqrkhmumd4.png", label: "Logistik" },
                      { value: "https://res.cloudinary.com/dtrymbvrp/image/upload/v1715088434/symbols/uaozccdgnwtcelxvqjug.png", label: "Fuhrpark" },
                      { value: "https://res.cloudinary.com/dtrymbvrp/image/upload/v1715088434/symbols/ke8amlflgcdrvdfghzoz.png", label: "IT & Services" },
                      { value: "https://res.cloudinary.com/dtrymbvrp/image/upload/v1715088433/symbols/gmnv44k0nydrmfnbr67y.png", label: "HR & Training" },
                      { value: "https://res.cloudinary.com/dtrymbvrp/image/upload/v1715088433/symbols/ip7khvjx1dgxosk6lxnb.png", label: "Buchhaltung" },
                      { value: "https://res.cloudinary.com/dtrymbvrp/image/upload/v1715088434/symbols/ydkcdshvmwdffe4tyf9f.png", label: "Einkauf & Anmietung" },
                      { value: "https://res.cloudinary.com/dtrymbvrp/image/upload/v1715088433/symbols/wodezi58z28wwhcvhsev.png", label: "Design & Planung" },
                      { value: "https://res.cloudinary.com/dtrymbvrp/image/upload/v1715088434/symbols/ikluglsekc6msbuvgn0z.png", label: "Projektmanagement" },
                      { value: "https://res.cloudinary.com/dtrymbvrp/image/upload/v1715088434/symbols/p0m4tdmsd5qdmysdzolk.png", label: "Officemanagement" },
                      { value: "https://res.cloudinary.com/dtrymbvrp/image/upload/v1715088433/symbols/l85s2hjejj6kzkzung8o.png", label: "Gesundheitsmanagement" },
                    ].map(({ value, label }) => (
                      <div key={value} className="flex items-center mb-1">
                        ...
                        />
                        <label className="ml-2 text-sm text-gray-900 dark:text-white">{label}</label>
                      </div>
                    ))}
                  </div>
