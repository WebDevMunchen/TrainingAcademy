...
const { createClassActivity, getAllActivities, registerClass, getActivity, increaseClassCapacity, decreaseClassCapacity, editClassActivity } = require("../controllers/classActivity-controller.js");
...
classActivityRouter.route("/editClass/:id").put(authenticate, editClassActivity);
